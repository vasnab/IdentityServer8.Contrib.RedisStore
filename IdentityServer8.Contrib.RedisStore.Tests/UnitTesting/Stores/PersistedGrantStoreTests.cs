...
using IdentityServer8.Contrib.RedisStore.Stores;
...
namespace IdentityServer8.Contrib.RedisStore.Tests.UnitTesting.Stores
{
    public class PersistedGrantStoreTests
    {
        ...
        public async Task RemoveAll_Entries()
        {
            ...
            await _store.RemoveAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1" });

            var actual = (await _store.GetAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId })).ToList();
        ...
        public async Task RemoveAll_Entries_With_SessionId()
        {
            ...
            await _store.RemoveAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1", SessionId = "session1" });
        ...
        public async Task RemoveAll_Entries_With_Type()
        {
            ...
            await _store.RemoveAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1", Type = "type2" });
        ...
        public async Task RemoveAll_Entries_WithType()
        {
            ...
            await _store.RemoveAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1", Type = "type1" });
        ...
        public async Task GetAllAsync_Retrieves_All_Grants_For_SubjectId_and_ClientId()
        {
            ...
            var actual = (await _store.GetAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1" })).ToList();
        ...
        public async Task GetAllAsync_Retrieves_All_Grants_For_SubjectId_and_Type()
        {
            ...
            var actual = (await _store.GetAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, Type = "type1" })).ToList();
        ...
        public async Task GetAllAsync_Retrieves_All_Grants_For_SubjectId_and_ClientId_And_Type()
        {
            ...
            var actual = (await _store.GetAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1", Type = "type1" })).ToList();
        ...
        public async Task GetAllAsync_Retrieves_All_Grants_For_SubjectId_and_ClientId_and_SessionId()
        {
            ...
            var actual = (await _store.GetAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1", SessionId = "session1" })).ToList();
        ...
        public async Task GetAllAsync_Retrieves_All_Grants_For_SubjectId_and_ClientId_and_SessionId_and_Type()
        {
            ...
            var actual = (await _store.GetAllAsync(new IdentityServer8.Stores.PersistedGrantFilter { SubjectId = subjectId, ClientId = "client1", SessionId = "session1", Type = "type1" })).ToList();
